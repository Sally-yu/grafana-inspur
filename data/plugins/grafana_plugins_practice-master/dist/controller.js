...
System.register(['app/plugins/sdk', 'lodash', 'app/core/utils/kbn', './echarts.simple.min'], function (_export, _context) {
    "use strict";
    ...
    return {
        ...
        }, function (_echartsSimpleMin) {
            echarts = _echartsSimpleMin.default;
        }],
        execute: function () {
